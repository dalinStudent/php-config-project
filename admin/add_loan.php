...
$r=mysqli_num_rows($sql);
		...
		header("Location: index.php?page=display_loan", TRUE, 301);
		exit();
		}
...
?>
<h2 class="page-header">Allow Loan</h2>
<form method="post">
...
echo "<option value='".$r1['group_id']."'>".$r1['group_name']."</option>";
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="col-sm-5">
		<input type="text" name="intereset" id="interest" value="3" readonly="true" class="form-control" required/></div>
	</div>
...
<input type="submit" value="Allow New Loan" name="save" class="btn btn-success"/>

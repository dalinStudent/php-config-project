...
//print_r($res);
?>
<h2 class="page-header">Update Allotted Loan Records</h2>
<form method="post">
...
<?php 
	...
	<div class="row" style="margin-top:10px">
		...
		<select name="source" class="form-control" required>
			...
			<option <?php if($res['loan_come_from']=="Council"){echo "selected";} ?>>District Council</option>
			<option <?php if($res['loan_come_from']=="Ministry"){echo "selected";} ?>>Ministry</option>
			<option <?php if($res['loan_come_from']=="Donors"){echo "selected";} ?>>Donors</option>
		</select>
		</div>
	</div>

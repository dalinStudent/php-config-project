...
<h2 class="page-header">List loan details</h2>
...
<Td>
	<a href="javascript:Deleteloan('<?php echo $row['loan_id']; ?>')" title="Delete loan payment" style='color:Red'><span class='glyphicon glyphicon-trash'></span></a>
	<a href="index.php?page=update_loan_record&loan_id=<?php echo $row['loan_id']; ?>" title="Update loan payment" style='color:green'><span class='glyphicon glyphicon-edit'></span></a>
</Td>

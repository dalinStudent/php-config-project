...
echo "<a style='text-decoration:underline' href='index.php?page=add_group_member'>Add New Member ?</a>";}
else
{
?>
<script>
...
<h2 class="page-header">List group members</h2>
...
<table class="table table-bordered">
	...
	<tr>
		<td colspan="8"><a href="index.php?page=add_group_member" class="btn btn-primary">Add New Member</a></td>
	</tr>
	<tr class="active">
		<th>Sr.No</th>
		<th>First Name</th>
...
<Td>
	<a href="javascript:DeleteMember('<?php echo $row['member_id']; ?>')" title="Delete member" style='color:Red'><span class='glyphicon glyphicon-trash'></span></a>
	<a href="index.php?page=update_group_member&member_id=<?php echo $row['member_id']; ?>" title="Update member" style='color:green'><span class='glyphicon glyphicon-edit'></span></a>
</Td>
<?php 

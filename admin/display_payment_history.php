...
<h2 class="page-header">All Payment Records</h2>
...
<Td>
	<a href="javascript:Deleteloan('<?php echo $row['payment_id']; ?>')" style='color:Red'><span class='glyphicon glyphicon-trash'></span></a>
</td>

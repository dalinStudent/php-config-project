      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="index.php?page=update_password"> Change Password <span class="glyphicon glyphicon-lock"></span></a></li>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <!-- <li><a href="#"><img style="border-radius:20px" src="../images/person.jpg" width="50" height="50" alt="not found"/></a></li> -->
